...
<head>
    ...
    <style>
       ...
       * element that contains the map. */
        ...
        /*size image within form using percentage*/
        image.inForm{
            height: auto;
            width: auto;
        }
...
<body>
    ...
    <div class="form-popup" id="markerInfoForm">
        <form action="/submitForm.php" class="form-container" autocomplete="off">
            ...
            <img id="eventImage" class="inForm" src="./assets/800px-Langensteins_Pothole_New_Orleans.jpg" alt="Event Image"  width="250" height="250">

            <label for="lat"><b><br>Latitude<br></b></label>
            <input type="text" placeholder="LAT" id="lat" readonly>

            <label for="lng"><b><br>Longitude<br></b></label>
            <input type="text" placeholder="LNG" id="lng" readonly>

            <label for="datetime"><b><br>Date/Time<br></b></label>
            <input type="text" placeholder="Date/Time" id="datetime" readonly>

            <label for="aiClass"><b><br>AI Classification<br></b></label>
            ...
            <label for="aiSev"><b><br>AI Severity<br></b></label>
            <input type="text" placeholder="AI Severity" id="aiSev" readonly>

            <label for="userClass"><b><br>User Classification<br></b></label>
            ...
            <label for="userSev"><b><br>User Severity<br></b></label>
    ...
    <script>
        ...
        var customColor = {
            ...
            1: {
                color: 'http://maps.google.com/mapfiles/kml/paddle/ylw-blank-lv.png'
            },
            2: {
                color: 'http://maps.google.com/mapfiles/kml/paddle/ylw-blank-lv.png'
            },
        ...
        function initMap() {
            ...
            // get map data by going to db, converting to XML and then building markers based on XML
            downloadUrl('/test/map/converttoXML.php', function(data) {
                var xml = data.responseXML;
                markers = xml.documentElement.getElementsByTagName('marker');
                Array.prototype.forEach.call(markers, function(markerElem) {
                    var id = markerElem.getAttribute('id');
                    var imageFileName = markerElem.getAttribute('imageFileName');
                    ...
                    var pin = customColor[aiSeverity] || {};
                    ...
                    marker.addListener('click', function() {
                        ...
                        document.getElementById("eventImage").src = "./assets/" + imageFileName
        ...
        function resetZoom(){
            map.setZoom(12);
            map.setCenter(new google.maps.LatLng(33.496458, -86.809695));
        }
